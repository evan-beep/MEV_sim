...
def decode_transaction_input(transac):
    try:
        abi = get_contract_abi(transac.to)
...
hx = decode_transaction_input(web3.eth.get_transaction(
    '0x8456ba82d2553862731c92dd0dc5d132bfadab07d118ee6c218fb13f632dcc9c'))
